...
public class Drawing extends SurfaceView implements Runnable, SurfaceHolder.Callback {
    private Paint paint;
    ...
    final short maplevel[][] = new short[][]{
